...
public class IabHelper {
    ...
    public static String getResponseDesc(int code) {
        ...
        String[] iabhelper_msgs = ("0:OK/-1001:Remote exception during initialization/" + "-1002:Bad response received/" + "-1003:Purchase signature verification failed/" + "-1004:Send intent failed/" + "-1005:User cancelled/" + "-1006:Unknown purchase response/" + "-1007:Missing token/" + "-1008:Unknown onError/" + "-1009:Subscriptions not available/" + "-1010:Invalid consumption attempt").split("/");
    ...
    private int queryPurchases(Inventory inv, String itemType) throws JSONException, RemoteException {
        ...
        do {
            ...
            Bundle ownedItems = mService.getPurchases(3, ApplicationUtils.getPackageName(), itemType, continueToken);
    ...
    private int querySkuDetails(String itemType, Inventory inv, List<String> moreSkus) throws RemoteException, JSONException {
        ...
        Bundle skuDetails = mService.getSkuDetails(3, ApplicationUtils.getPackageName(), itemType, querySkus);
    ...
    private void consumeAsyncInternal(final List<Purchase> purchases, final OnConsumeFinishedListener singleListener, final OnConsumeMultiFinishedListener multiListener) {
        final Handler handler = new Handler();
